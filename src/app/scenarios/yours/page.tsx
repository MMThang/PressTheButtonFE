...
const YoursPage = () => {
    ...
    const { data: scenarioData, refetch: refetchData } = useQuery({
        queryKey: ['YourScenario', query],
        queryFn: getYourScenario,
        retry: 3,
        enabled: true
    });
    ...
    return (
        <div className="w-full h-full bg-indigo-500 flex justify-center">
            <div className="w-1/2 h-full flex flex-col items-center justify-star md:w-full">
